...
# timeouts
SOFT_VISIT_TIMEOUT = 120     # timeout used by selenium when attempting to load the page (before loading site)
HARD_VISIT_TIMEOUT = SOFT_VISIT_TIMEOUT + 10  # hard timeout used by process and dumpcap to terminate irregardless of site load status
